...
var LocusInfo = /*#__PURE__*/function (_EventsScope) {
  ...
  (0, _createClass2.default)(LocusInfo, [{
      ...
      if (controls && !(0, _isEqual2.default)(this.controls, controls)) {
        ...
        if (hasMeetingContainerChanged) {
          ...
          this.emitScoped({
            file: 'locus-info',
            function: 'updateControls'
          }, _constants.LOCUSINFO.EVENTS.CONTROLS_MEETING_CONTAINER_UPDATED, {
        ...
        if (hasTranscribeChanged) {
          ...
          this.emitScoped({
            file: 'locus-info',
            function: 'updateControls'
          }, _constants.LOCUSINFO.EVENTS.CONTROLS_MEETING_TRANSCRIBE_UPDATED, {
    ...
    value: function updateEmbeddedApps(embeddedApps) {
      ...
      this.parsedLocus.embeddedApps = _embeddedAppsUtils.default.parse(embeddedApps);
      this.emitScoped({
        file: 'locus-info',
        function: 'updateEmbeddedApps'
      }, _constants.LOCUSINFO.EVENTS.EMBEDDED_APPS_UPDATED, embeddedApps);
      ...
      if (self && !(0, _isEqual2.default)(this.self, self)) {
        ...
        if (parsedSelves.updates.layoutChanged) {
          this.emitScoped({
            file: 'locus-info',
            function: 'updateSelf'
          }, _constants.LOCUSINFO.EVENTS.CONTROLS_MEETING_LAYOUT_UPDATED, {
